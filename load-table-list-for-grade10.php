...
$sql1 = "SELECT * FROM enrollee WHERE status = 'ENROLLED' AND grade_level = '10' ";
$sql2 = "SELECT * FROM transferee_returnee WHERE status = 'ENROLLED' AND grade_level = '10' ";
...
if (null !== $result1 || null !== $result2) {
    ...
    echo '<th scope="col" colspan="9" style="text-align:center;">All Grade 10</th>';
...
<script>
  ...
  xhr.open("POST", "generatePDFforgrade10.php", true);
  ...
  xhr.onreadystatechange = function() {
    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
      ...
      link.href = url;
      link.download = "Enrolled-List-For-Grade-10.pdf"; // Set the filename of the downloaded file

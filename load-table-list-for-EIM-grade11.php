...
if (null !== $result1 || null !== $result2) {
    ...
    echo '<th scope="col" colspan="9" style="text-align:center;">All EIM Grade 11</th>';
...
<script>
  ...
  xhr.open("POST", "generatePDFforEIMgrade11.php", true);
  ...
  xhr.onreadystatechange = function() {
    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
      ...
      link.href = url;
      link.download = "Enrolled-List-For-EIM-Grade-11.pdf"; // Set the filename of the downloaded file
